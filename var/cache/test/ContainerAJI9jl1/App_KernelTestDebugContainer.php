...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\InfractionController' => 'getInfractionControllerService',
    ...
    /**
     * Gets the private '.service_locator.al0B.Av' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_Al0B_AvService($container)
    {
        return $container->privates['.service_locator.al0B.Av'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    protected static function getDebug_ControllerResolver_InnerService($container)
    {
        ...
        $instance->allowControllers(['App\\Kernel', 'App\\Controller\\AuthController', 'App\\Controller\\DriverController', 'App\\Controller\\InfractionController', 'App\\Controller\\TeamController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        $a = ($container->privates['.service_locator.al0B.Av'] ?? self::get_ServiceLocator_Al0B_AvService($container));
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.register' => ($container->privates['.security.request_matcher.0Cg.W.T'] ?? $container->load('get_Security_RequestMatcher_0Cg_W_TService'));
